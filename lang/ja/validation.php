...
return [
    ...
    'doesnt_contain'         => ':attributeには、以下のいずれも含めることはできません: :values',
    ...
    'in_array_keys'          => ':attributeには、以下のキーの少なくとも1つを含める必要があります: :values',
    ...
    'custom'                 => [
        ...
        'happened_at' => [
            'required' => '発生日時は必須項目です。',
            'date'     => '発生日時は正しい日付形式で入力してください。',
        ],
        'situation' => [
            'required' => '状況は必須項目です。',
            'max'      => '状況は2000文字以内で入力してください。',
        ],
        'cause' => [
            'required' => '原因は必須項目です。',
            'max'      => '原因は2000文字以内で入力してください。',
        ],
        'my_solution' => [
            'required' => '解決法は必須項目です。',
            'max'      => '解決法は2000文字以内で入力してください。',
        ],
        'supplement' => [
            'max' => '補足は2000文字以内で入力してください。',
        ],
        'tag_name' => [
            'max' => 'タグ名は10文字以内で入力してください。',
        ],
        'tags' => [
            'required' => 'タグは最低1つ選択してください。',
        ],
    ],
    ...
    'attributes'             => [
        ...
        'supplement'               => '補足',
        're_ai_notes'              => 'AI解決策',
        'reminder_date'            => 'リマインド日時',
        'is_reminded'              => 'リマインド済みフラグ',
    ],
];
